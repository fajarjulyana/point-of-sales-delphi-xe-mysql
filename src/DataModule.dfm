object DataModuleActive: TDataModuleActive
  ...
  object ADOQuery1: TADOQuery
    ...
    SQL.Strings = (
        ...
        'SELECT detail_penjualan.id, produk.nama_produk, detail_penjualan' +
        '.subtotal  FROM detail_penjualan JOIN produk ON produk.id = deta' +
        'il_penjualan.id_produk')
    Left = 40
    Top = 80
  end
  object ADOQuery2: TADOQuery
    ...
    Parameters = <>
    SQL.Strings = (
      'select sum(subtotal) from detail_penjualan')
    Left = 88
    Top = 80
  end
